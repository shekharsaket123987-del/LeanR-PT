  ...
  if (created) {
    return (
      <div className="mx-auto max-w-xl">
        <Card className="p-6">
          <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-400/15">
    ...
    <div className="mx-auto max-w-3xl">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            ...
            <input
              ...
              className="w-full glass-faint rounded-xl p-3 text-sm text-white placeholder:text-white/30 outline-none focus:border-brand-yellow focus:ring-1 focus:ring-brand-yellow"
            />
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="w-full glass-faint rounded-xl p-3 font-mono text-sm text-white placeholder:text-white/30 outline-none focus:border-brand-yellow focus:ring-1 focus:ring-brand-yellow"
              />
      ...
      <Card className="mt-6 p-6">
        ...
        <select
          ...
          className="mb-4 w-full glass-faint rounded-xl p-3 text-sm text-white outline-none focus:border-brand-yellow focus:ring-1 focus:ring-brand-yellow"
        >
          {COACH_SKILLS.map((s) => (
      ...
      <Card className="mt-6 p-6">
        ...
        <div className="space-y-3">
          {slots.map((slot) => (
            <div key={slot.id} className="glass-faint rounded-xl p-4">
              <div className="mb-3 flex items-center justify-between">
                <select
                  value={slot.startTime}
                  onChange={(e) => updateSlotTime(slot.id, e.target.value)}
                  className="glass-faint rounded-lg px-2 py-1.5 text-sm text-white outline-none"
                >
                  {HOUR_GRID.map((h) => (
