...
export default async function AdminRenewalsPage() {
  ...
  if (isFailure(result)) {
    return (
      <div className="mx-auto max-w-5xl">
        <PageHeader title="Renewal Opportunities" description="Every client running low on sessions or expired, platform-wide." />
  ...
  return (
    <div className="mx-auto max-w-5xl">
      <PageHeader title="Renewal Opportunities" description="Every client running low on sessions or expired, platform-wide." />
      <RenewalOpportunitiesClient rows={result.data} role="admin" />
    </div>
  );
}
