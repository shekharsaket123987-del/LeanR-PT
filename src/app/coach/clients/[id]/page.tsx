  ...
  return (
    <div className="mx-auto max-w-5xl">
      ...
      {!client.isAssignedToMe && (
        <div className="mb-6 glass-faint rounded-xl px-4 py-3 text-xs text-white/60">
            ...
            <div className="mt-5 space-y-4 border-t border-white/[0.06] pt-4">
              <div>
                ...
                <div className="flex flex-wrap gap-1.5">
                  ...
                  {client.goals.map((g) => (
                    <span key={g} className="rounded-full bg-white/10 px-2.5 py-1 text-[11px] font-semibold">{g}</span>
                  ))}
                </div>
              </div>
              <div>
