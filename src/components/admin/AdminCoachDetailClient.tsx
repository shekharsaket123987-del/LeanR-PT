  ...
  return (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
      ...
      <Modal open={blockOpen} onClose={() => setBlockOpen(false)} title="Override / Block Slot">
        <div className="space-y-4">
          ...
          <div>
            ...
            <input type="date" value={blockDate} onChange={(e) => setBlockDate(e.target.value)} className="w-full glass-faint rounded-xl p-3 text-sm text-white" />
          </div>
          <div>
            <label className="mb-1.5 block text-xs font-bold uppercase text-white/40">Reason (optional)</label>
            <input value={blockReason} onChange={(e) => setBlockReason(e.target.value)} className="w-full glass-faint rounded-xl p-3 text-sm text-white" />
          </div>
      ...
      >
        ...
        <select value={reassignTo} onChange={(e) => setReassignTo(e.target.value)} className="w-full glass-faint rounded-xl p-3 text-sm text-white">
      ...
      <Modal open={editOpen} onClose={() => setEditOpen(false)} title="Edit Coach">
        <div className="space-y-4">
          <div>
            ...
            <input value={editName} onChange={(e) => setEditName(e.target.value)} className="w-full glass-faint rounded-xl p-2.5 text-sm text-white" />
          </div>
          <div>
