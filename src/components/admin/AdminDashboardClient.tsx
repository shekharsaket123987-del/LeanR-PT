        ...
        <Card className="p-6 lg:col-span-2">
          ...
          <ResponsiveContainer width="100%" height={260}>
            <LineChart data={revenueTrend}>
              ...
              <XAxis dataKey="month" tickLine={false} axisLine={false} tick={{ fontSize: 12, fill: "#ffffff60" }} />
              <YAxis
                tickLine={false}
                axisLine={false}
              ...
              />
              <Tooltip
                contentStyle={{ borderRadius: 12, border: "1px solid #ffffff1a", background: "#0C0C0C", fontSize: 12, color: "#fff" }}
      ...
      <Card className="mt-6 p-6">
        ...
        <ResponsiveContainer width="100%" height={220}>
          <BarChart data={bookingsByHour}>
            <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#ffffff14" />
            <XAxis dataKey="hour" tickLine={false} axisLine={false} tick={{ fontSize: 12, fill: "#ffffff60" }} />
            <YAxis tickLine={false} axisLine={false} tick={{ fontSize: 12, fill: "#ffffff60" }} width={24} />
            <Tooltip cursor={{ fill: "#ffffff0a" }} contentStyle={{ borderRadius: 12, border: "1px solid #ffffff1a", background: "#0C0C0C", fontSize: 12, color: "#fff" }} />
