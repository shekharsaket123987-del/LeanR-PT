    ...
    <div className="mx-auto max-w-2xl">
      <div className="relative">
        ...
        <input
          ...
          className="w-full glass-faint rounded-xl py-3 pl-10 pr-4 text-sm text-white placeholder:text-white/30 outline-none focus:border-brand-yellow focus:ring-1 focus:ring-brand-yellow"
        />
      </div>
