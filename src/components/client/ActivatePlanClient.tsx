  ...
  return (
    <Card className="p-6">
      ...
      <div className="mt-5">
        ...
        <input type="date" value={startDate} min={tomorrowISO()} onChange={(e) => setStartDate(e.target.value)} className="w-full max-w-xs rounded-xl border border-white/15 p-3 text-sm" />
      </div>
