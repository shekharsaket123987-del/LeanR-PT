    ...
    <div className="mx-auto max-w-3xl">
      ...
      {step === "intro" && !isFirstSession && (
        <Card className="p-6">
          ...
          <p className="mt-4 rounded-xl bg-white/[0.04] p-3 text-xs text-white/50">
      ...
      {step === "confirm" && bookedId && selectedSlot && (
        <Card className="p-6">
          <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-400/15">
