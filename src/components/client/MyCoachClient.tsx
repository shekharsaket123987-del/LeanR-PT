  ...
  return (
    <>
      ...
      {request?.status === "rejected" && (
        <Card className="mb-6 border-red-200 bg-red-400/10 p-4">
      ...
      {request?.status === "approved" && !needsCompletion && (
        <Card className="mb-6 border-emerald-400/25 bg-emerald-400/10 p-4">
      ...
      {needsCompletion && (
        <Card className="mb-6 p-5">
          ...
          <input type="time" value={timeOfDay} onChange={(e) => setTimeOfDay(e.target.value)} className="mt-3 w-full max-w-[160px] rounded-xl border border-white/15 p-2.5 text-sm" />
      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Request Coach Change">
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea value={additionalComments} onChange={(e) => setAdditionalComments(e.target.value)} rows={2} className="w-full rounded-xl border border-white/15 p-3 text-sm" />
          </div>
