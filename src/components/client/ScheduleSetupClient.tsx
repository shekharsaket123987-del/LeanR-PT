    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <Card className="p-6">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          ...
          <div>
            <p className="mb-2 text-xs font-bold uppercase tracking-wide text-white/40">Days</p>
            <select
              value={pattern}
              onChange={(e) => {
        ...
        {pattern === "custom" && (
          <div className="mt-4">
            <p className="mb-2 text-xs text-white/50">Pick 2–5 days ({customDays.length} selected)</p>
