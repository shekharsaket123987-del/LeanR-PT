      ...
      <div className="mb-5 flex flex-col gap-3">
        <div className="relative">
          ...
          <input
            ...
            className="glass-faint w-full rounded-xl py-2.5 pl-10 pr-4 text-sm text-white placeholder:text-white/30 outline-none focus:border-brand-yellow focus:ring-1 focus:ring-brand-yellow"
          />
        </div>
        <div className="flex flex-wrap gap-2">
            ...
            {(["all", "active", "waiting_to_start", "paused", "completed"] as const).map((s) => (
              <button
                ...
                className={`whitespace-nowrap rounded-lg px-3 py-1.5 text-xs font-bold ${
                  statusFilter === s ? "bg-white/10 text-white" : "text-white/50"
                }`}
              >
          ...
          <select
            ...
            className="glass-faint rounded-xl px-3 py-2 text-xs font-semibold text-white outline-none"
          >
          ...
          {filtered.map((c) => {
            ...
            return (
              <Link
                ...
                className="grid grid-cols-2 items-center gap-4 px-5 py-4 hover:bg-white/[0.04] sm:grid-cols-12"
              >
