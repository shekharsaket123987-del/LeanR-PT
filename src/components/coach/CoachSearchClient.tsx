    ...
    <div className="mx-auto max-w-2xl">
      <div className="relative">
        ...
        <input
          ...
          className="glass-faint w-full rounded-xl py-3 pl-10 pr-4 text-sm text-white placeholder:text-white/30 outline-none focus:border-brand-yellow focus:ring-1 focus:ring-brand-yellow"
        />
      </div>
      ...
      <div className="mt-4 space-y-2">
        ...
        {filtered.map((c) => (
          <Link key={c.id} href={`/coach/clients/${c.id}`}>
            <Card className="flex items-center gap-3 p-3.5 transition-colors hover:bg-white/[0.04]">
