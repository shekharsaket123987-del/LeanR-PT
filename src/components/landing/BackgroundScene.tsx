...
/**
 * One waypoint per page section, evenly spaced across scroll progress 0-1.
 * Interpolating between neighbours gives a gentle cylindrical/orbital drift
 * instead of one straight linear dolly.
 */
...
/**
 * Ambient 3D backdrop for the public marketing/login routes only — never
 * mounted inside the authenticated portals, since a persistent WebGL canvas
 * plus its animation loop is real GPU/battery cost that data-dense
 * dashboards shouldn't pay for.
 */
