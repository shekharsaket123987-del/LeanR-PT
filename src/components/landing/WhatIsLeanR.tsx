...
const PILLARS: Pillar[] = [
  {
    Icon: SpaceIcon,
    title: "Your Space",
    desc: "Train from the comfort of your home.",
    z: 0,
    from: "top-left",
  },
  {
    Icon: CoachIcon,
    title: "Your Coach",
    desc: "Expert coaches dedicated to your transformation.",
    z: 18,
    from: "top-right",
  },
  {
    Icon: ScheduleIcon,
    title: "Your Schedule",
    desc: "Flexible timings that fit your lifestyle.",
    z: 34,
    from: "bottom-left",
  },
  {
    Icon: GoalIcon,
    title: "Your Goal",
    desc: "Personalized plans focused on your goals.",
    z: 50,
    from: "bottom-right",
  },
];
      ...
      >
        ...
        >
          <motion.div style={{ rotateX, rotateY, transformStyle: "preserve-3d" }} className="h-full">
            <motion.div
              className="glass group h-full rounded-2xl p-4"
              whileHover={{
                y: -6,
                borderColor: "rgba(245,217,10,0.6)",
                boxShadow: "0 0 50px -12px rgba(245,217,10,0.45)",
              }}
          ...
          <div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr] items-center">
            <Reveal>
              ...
              <h2 className="text-display mt-4 text-3xl sm:text-4xl leading-[0.95]">
                WHAT IS
                <br />
                <span className="text-glow text-brand-yellow">LEANR?</span>
              </h2>
              <span className="mt-3 block h-px w-14 bg-brand-yellow" />
              <p className="mt-4 max-w-md text-sm text-white/65 leading-relaxed">
                LeanR is an online 1:1 personal training platform that connects
                you with expert coaches for customized workouts, real-time
                guidance and measurable results.
              </p>
              <p className="mt-2 max-w-md text-sm text-white/65 leading-relaxed">
                Train from the comfort of your home with flexible scheduling,
                professional support and a program built around your goals.
              </p>
            </Reveal>
