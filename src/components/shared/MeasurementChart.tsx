      ...
      {data.length < 2 ? (
        ...
        <ResponsiveContainer width="100%" height={240}>
          <LineChart data={data} margin={{ top: 5, right: 10, left: -10, bottom: 0 }}>
            ...
            <XAxis dataKey="date" tick={{ fontSize: 11, fill: "#FFFFFF66" }} axisLine={{ stroke: "#FFFFFF1A" }} tickLine={false} />
            <YAxis tick={{ fontSize: 11, fill: "#FFFFFF66" }} axisLine={false} tickLine={false} unit={metric.unit} width={46} />
            <Tooltip
            ...
            />
            <Line type="monotone" dataKey="value" stroke="#F5D90A" strokeWidth={2.5} dot={{ fill: "#F5D90A", stroke: "#0c0c0c", strokeWidth: 2, r: 4 }} />
          </LineChart>
        </ResponsiveContainer>
      )}
    </div>
