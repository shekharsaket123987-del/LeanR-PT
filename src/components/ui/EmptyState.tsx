...
export default function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-white/15 bg-white/[0.02] px-6 py-16 text-center">
      <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full glass-yellow">
        <Icon className="h-7 w-7 text-brand-yellow" strokeWidth={1.75} />
      </div>
      <h3 className="text-display text-lg font-bold italic text-white">{title}</h3>
