...
/**
 * Shared outer container for every major section — a floating dark-glass
 * slab sitting above the black background, with a very subtle mouse-driven
 * tilt. Sections keep their own unique content; only this wrapper is shared,
 * so every section reads as a distinct panel rather than one continuous
 * surface.
 */
export default function GlassSectionPanel({
  ...
  return (
    <div ref={ref} onMouseMove={handleMove} onMouseLeave={handleLeave} style={{ perspective: 1800 }}>
      ...
      >
        {/* soft inner top highlight — reads as a reflection along the glass edge */}
